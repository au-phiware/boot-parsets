...
import { dispatch, select, scale, transition, interpolateNumber, range, behavior, event, functor, rebind, mouse, keys, format } from 'd3';
const d3 = { dispatch, select, scale, transition, interpolateNumber, range, behavior, event, functor, rebind, mouse, keys, format };

const d3_parsets = function() {
